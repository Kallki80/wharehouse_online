...
// // import 'package:universal_html/html.dart' as html;  // Add to pubspec.yaml if web support needed
...
//       // Browser web download disabled (add universal_html to pubspec.yaml for support)
//       // if (kIsWeb) { ... }
      
//       // Universal Documents folder for mobile/desktop (works Linux/Mac/Win/Android/iOS)
//         // Mobile/Desktop: Save to Documents folder
...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  static String _getTableName(AdminTableType type) {
    switch (type) {
      ...
      case AdminTableType.clientList: return 'client list';
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (c) => const AdminLogin())),
          ),
        ],
      ),
      body: Column(children: [
